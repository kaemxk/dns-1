...
export const Geolocation = () => {
  ...
  const Modal = () => {
    return (
      <div className='absolute top-9 z-50 ml-1 flex w-[320px] max-w-[320px] flex-row flex-wrap rounded-lg bg-white p-[23px] text-[#333] shadow-[0_0_0_1px_rgba(0,0,0,.04),0_4px_4px_rgba(0,0,0,.04),0_20px_40px_rgba(0,0,0,.08)] transition-all min-[320px]:right-0 lg:left-[-20px]'>
