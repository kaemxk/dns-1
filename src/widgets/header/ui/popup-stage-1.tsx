...
interface IPopupStageOneProps {
  popupClosed: boolean
}

export const PopupStageOne: FC<IPopupStageOneProps> = ({ popupClosed }) => {
  return (
    <div
      className={`${!popupClosed ? 'animate-fadeIn' : 'animate-fadeOut'} transform transition-all duration-200`}
    >
